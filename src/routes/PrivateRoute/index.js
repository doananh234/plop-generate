...
const restRoutes = [

    {
      path: '/asdasd',
      component: Loadable({
        loader: () => import('../../containers/Asdasd/List'),
        loading: Loading,
      }),
    },

    {
      path: '/tesss',
      component: Loadable({
        loader: () => import('../../containers/Tesss/List'),
        loading: Loading,
      }),
    },];
...
const modalRoutes = [

    {
      path: '/asdasd/create',
      component: Loadable({
        loader: () => import('../../containers/Asdasd/Create'),
        loading: Loading,
      }),
    },
    {
      path: '/asdasd/:id/edit',
      component: Loadable({
        loader: () => import('../../containers/Asdasd/Edit'),
        loading: Loading,
      }),
    },
    {
      path: '/asdasd/:id/show',
      component: Loadable({
        loader: () => import('../../containers/Asdasd/Show'),
        loading: Loading,
      }),
    },

    {
      path: '/tesss/create',
      component: Loadable({
        loader: () => import('../../containers/Tesss/Create'),
        loading: Loading,
      }),
    },
    {
      path: '/tesss/:id/edit',
      component: Loadable({
        loader: () => import('../../containers/Tesss/Edit'),
        loading: Loading,
      }),
    },
    {
      path: '/tesss/:id/show',
      component: Loadable({
        loader: () => import('../../containers/Tesss/Show'),
        loading: Loading,
      }),
    },];
// Pages
